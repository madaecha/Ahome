					...
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							if ($this->session->userdata('user_type') == 3) {
								...
								$complaints = $this->db->get_where('complaint', array('tenant_id' => $tenant_id, 'status' => 0))->result_array();
							} else {
								$complaints = $this->db->get_where('complaint', array('status' => 0))->result_array();
							}
