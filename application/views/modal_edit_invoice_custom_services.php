    ...
    <div class="col-lg-12">
        <div class="note note-primary">
            <div class="note-content">
                ...
                - <?php echo $this->lang->line('invoice_custom_service_note_0') . '<br>'; ?>
                - <?php echo $this->lang->line('invoice_custom_service_note_1') . '<br>'; ?>
                - <?php echo $this->lang->line('invoice_custom_service_note_2') . '<br>'; ?>
                - <?php echo $this->lang->line('invoice_custom_service_note_3'); ?>
            </div>
        </div>
    </div>
</div>
<?php echo form_open('invoice_custom_services/' . $param2, array('id' => 'edit_invoice_custom_services', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<div id="custom-dynamic-field">
    <?php
        $invoice_services = $this->db->get_where('invoice_custom_service', array('invoice_id' => $param2))->result_array();
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input value="<?php echo html_escape($row['name']); ?>" type="text" name="names[]" placeholder="<?php echo $this->lang->line('invoice_custom_service_name_placeholder'); ?>" class="form-control" data-parsley-required="true">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input value="<?php echo html_escape($row['amount']); ?>" type="text" name="amounts[]" placeholder="<?php echo $this->lang->line('invoice_custom_service_amount_placeholder'); ?>" class="form-control" data-parsley-required="true">
            </div>
        </div>
    </div>
    <?php endforeach; ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <span style="margin-bottom: 10px" class="btn btn-primary pull-right" id="custom-add-more">
...
<script>
	$('#edit_invoice_custom_services').parsley();
	FormPlugins.init();
    ...
    $(document).ready(function() {
		...
		var i = 0;
		$('#custom-add-more').on('click', function() {
			i++;
			$('#custom-dynamic-field').append(`
			<div id="row` + i + `">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label><?php echo $this->lang->line('service_name'); ?> *</label>
                            <input type="text" name="names[]" placeholder="<?php echo $this->lang->line('invoice_custom_service_name_placeholder'); ?>" class="form-control" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><?php echo $this->lang->line('amount'); ?> *</label>
                            <input type="text" name="amounts[]" placeholder="<?php echo $this->lang->line('invoice_custom_service_amount_placeholder'); ?>" class="form-control" data-parsley-required="true">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
