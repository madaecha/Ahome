...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active"><?php echo $this->lang->line('currency_settings'); ?></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">
    <?php echo $this->lang->line('currency_settings_header'); ?>
    </h1>
    <!-- end page-header -->
    ...
    <div class="row">
                    ...
                    <table id="data-table-buttons" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-nowrap"><?php echo $this->lang->line('symbol'); ?></th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-xs" href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_currency/<?php echo $row['currency_id']; ?>');">
                                            <i class="fa fa-edit"></i> <?php echo $this->lang->line('edit'); ?>
                                        </a>
                                        <a class="btn btn-danger btn-xs" href="javascript:;" onclick="confirm_modal('<?php echo base_url('currency_settings/remove/' . $row['currency_id']); ?>');">
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-inverse">
                <!-- begin panel-body -->
                <div class="panel-body">
                    <?php echo form_open('currency_settings/add', array('method' => 'post', 'data-parsley-validate' => 'true')); ?>
                    <div class="form-group">
                        <label><?php echo $this->lang->line('name'); ?> *</label>
                        <input type="text" name="name" placeholder="<?php echo $this->lang->line('currency_name_placeholder'); ?>" class="form-control" data-parsley-required="true">
                    </div>
                    <div class="form-group">
                        <label><?php echo $this->lang->line('symbol'); ?> *</label>
                        <input type="text" name="code" placeholder="<?php echo $this->lang->line('currency_symbol_placeholder'); ?>" class="form-control" data-parsley-required="true">
                    </div>
